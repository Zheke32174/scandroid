...
For the full 3+3 inheritance line (internal triad + external
lineages absorbed) see [INHERIT.md](INHERIT.md). CLUSTER.md is
the topology surface; INHERIT.md is the spine.
